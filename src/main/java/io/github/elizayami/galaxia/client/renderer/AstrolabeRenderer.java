...
public class AstrolabeRenderer extends TileEntityRenderer<RotatingBlock>
{
	private final Block block;
	private final boolean fullRotation;

	public AstrolabeRenderer(TileEntityRendererDispatcher rendererDispatcherIn, Block block, boolean fullRotation)
	{
