...
public class GemMaterial 
{
	...
	{
		return new GemMaterial(name, true, AbstractBlock.Properties.create(Material.IRON, color).setRequiresTool().hardnessAndResistance(5.0F, 6.0F).sound(SoundType.METAL), new Item.Properties().group(Galaxia.galaxiaGroup), material, armor);
	}
	
	public static GemMaterial makeNormal(String name, MaterialColor color, float hardness, float resistance, IItemTier material, IArmorMaterial armor) 
	{
		return new GemMaterial(name, true, AbstractBlock.Properties.create(Material.IRON, color).setRequiresTool().hardnessAndResistance(hardness, resistance).sound(SoundType.METAL), new Item.Properties().group(Galaxia.galaxiaGroup), material, armor);
	}
	
	public static GemMaterial makeOreless(String name, MaterialColor color, IItemTier material, IArmorMaterial armor)
	{
		return new GemMaterial(name, false, AbstractBlock.Properties.create(Material.IRON, color).setRequiresTool().hardnessAndResistance(5.0F, 6.0F).sound(SoundType.METAL), new Item.Properties().group(Galaxia.galaxiaGroup), material, armor);
	}
	
	public static GemMaterial makeOreless(String name, MaterialColor color, float hardness, float resistance, IItemTier material, IArmorMaterial armor) {
		return new GemMaterial(name, false, AbstractBlock.Properties.create(Material.IRON, color).setRequiresTool().hardnessAndResistance(hardness, resistance).sound(SoundType.METAL), new Item.Properties().group(Galaxia.galaxiaGroup), material, armor);
	}
	
	public GemMaterial(String name, boolean hasOre, AbstractBlock.Properties blockSettings, Item.Properties itemSettings, IItemTier material, IArmorMaterial armor) 
	{		
		this.hasOre = hasOre;
		...
		else
		{
	        ...
	        helmet = ItemInit.registerItem(name + "_helmet", () -> new GalaxiumArmor(armor, EquipmentSlotType.HEAD, itemSettings));
	        chestplate = ItemInit.registerItem(name + "_chestplate", () -> new GalaxiumArmor(armor, EquipmentSlotType.CHEST, itemSettings));
	        leggings = ItemInit.registerItem(name + "_leggings", () -> new GalaxiumArmor(armor, EquipmentSlotType.LEGS, itemSettings));
	        boots = ItemInit.registerItem(name + "_boots", () -> new GalaxiumArmor(armor, EquipmentSlotType.FEET, itemSettings));
		}
