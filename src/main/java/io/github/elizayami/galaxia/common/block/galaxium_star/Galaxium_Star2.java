 ...
 */
public class Galaxium_Star2 extends Block implements IWaterLoggable {
    ...
    public Galaxium_Star2(String registryName, VoxelShape shape, Supplier<? extends TileEntity> tileProvider)
    {
