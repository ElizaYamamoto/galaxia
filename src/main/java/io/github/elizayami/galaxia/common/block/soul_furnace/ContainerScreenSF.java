...
public class ContainerScreenSF extends ContainerScreen<ContainerSF> {
	...
	private ContainerSF containerFurnace;

	public ContainerScreenSF(ContainerSF containerFurnace, PlayerInventory playerInventory, ITextComponent title) {
	...
	final static int PLAYER_INV_LABEL_XPOS = ContainerSF.PLAYER_INVENTORY_XPOS;
	final static int PLAYER_INV_LABEL_YPOS = ContainerSF.PLAYER_INVENTORY_YPOS - FONT_Y_SPACING;
	...
	private static final ResourceLocation TEXTURE = new ResourceLocation("galaxia", "textures/soulfurnace.png");
}
