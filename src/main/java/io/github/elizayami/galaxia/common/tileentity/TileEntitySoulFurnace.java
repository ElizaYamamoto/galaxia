...
public class TileEntitySoulFurnace extends TileEntity implements INamedContainerProvider, ITickableTileEntity
{
	...
	public void tick()
	{
		...
		BlockState newBlockState = currentBlockState.with(Soul_Furnace.NUMBER_BURNING, numberBurning);
	...
	{
		return new TranslationTextComponent("container.galaxia.soul_furnace");
	}
	...
	{
		return ContainerSF.createContainerServerSide(windowID, playerInventory, inputZoneContents, outputZoneContents,
