...
public class BiomeData
{
	...
	public BiomeData(Biome biome, int biomeWeight, @Nullable BiomeManager.BiomeType biomeType,
			BiomeDictionary.Type[] dictionary, WeightedList<Biome> biomeWeightedList, Biome edgeBiome, Biome beachBiome,
			Biome river)
	{
		this.biome = biome;
	...
	{
		if (!Arrays.stream(this.dictionaryType).collect(Collectors.toList()).contains(BiomeDictionary.Type.OCEAN)
				&& biomeType == null)
		{
			throw new UnsupportedOperationException(
					"The biome climate was null in a non ocean biome, this should NEVER happen!");
		}
		return biomeType;
	}
