...
public class BlockInit 
{
    ...
    public static class RegistryEvents
    {
        ...
        {
        	Star.getRegistry().register(new Galaxium_Star("galaxium_star", Galaxium_Star.Shape, () -> new RotatingBlock(galaxium_star_tile)));

        	Star.getRegistry().register(new Galaxium_Star("galaxium_star2", Galaxium_Star2.Shape, () -> new RotatingBlock(galaxium_star_tile2)));
        }
    	
        @SubscribeEvent
        public static void onTileRegistry(final RegistryEvent.Register<TileEntityType<?>> Star)
        {
        	Star.getRegistry().register(TileEntityType.Builder.create(() -> new RotatingBlock(galaxium_star_tile), GALAXIUM_STAR).build(null).setRegistryName("galaxium_star_tile"));
        	
        	Star.getRegistry().register(TileEntityType.Builder.create(() -> new RotatingBlock(galaxium_star_tile2), GALAXIUM_STAR2).build(null).setRegistryName("galaxium_star_tile2"));
        }
    }
	
	public static final RegistryObject<FallingBlock> IMPACT_SAND = BLOCKS.
			register("impact_sand",
	...
	public static final SandstoneMaterial SOULSANDSTONE = createSandstoneMaterial("soul_sandstone", MaterialColor.BROWN);
	
	public static final SandstoneMaterial IMPACTSANDSTONE = createSandstoneMaterial("impact_sandstone", MaterialColor.BROWN);
    ...
    public static final GemMaterial GALAXIUM = createGemMaterial("galaxium", true, AbstractBlock.Properties.create(Material.IRON, MaterialColor.PURPLE).setRequiresTool().hardnessAndResistance(5.0F, 6.0F).sound(SoundType.GILDED_BLACKSTONE), new Item.Properties().group(Galaxia.galaxiaGroup), ToolMaterials.GALAXIUM, ArmorMaterials.GALAXIUM);
	...
	public static GemMaterial createGemMaterial(String name, boolean hasOre, AbstractBlock.Properties blockSettings, Item.Properties itemSettings, IItemTier itemTier, IArmorMaterial armor) {
