...
import io.github.elizayami.galaxia.core.init.BoatInit.BoatData.DefaultBoatData;
...
public final class BoatInit
{
	...
	public static synchronized void registerBoat(String boatName, RegistryObject<Item> boat,
